...
public class MovieController {
    ...
    @PostMapping("/modify")
    public String modify(MovieDTO movieDTO, PageRequestDTO pageRequestDTO , RedirectAttributes redirectAttributes){

        log.info("modify movieDTO: " + movieDTO);
